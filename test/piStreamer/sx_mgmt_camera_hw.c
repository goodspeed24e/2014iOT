...
void raspipreview_set_defaults(RASPIPREVIEW_PARAMETERS *state)
{
   ...
   state->previewWindow.width = 320; //1024;
   state->previewWindow.height = 240;//768;
    ...
    )
{
   ...
   state->width = 320;//1280;       // Default to 1080p
   state->height = 240;//720;
   state->bitrate = 300000;//1000000; // This is a decent default bitrate for 1080p
   state->framerate = 10;
