...
default_path = '/usr/local/id/streaming_pb_downloader/configs'
...
config.set('Downloader', 'Application', '/usr/local/id/streaming_pb_downloader/bin/streaming_pb_downloader')
...
config.set('Event Name List', 'Filename', '/usr/local/id/streaming_pb_downloader/configs/event_name_list.txt')
